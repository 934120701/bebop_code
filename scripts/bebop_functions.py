...
def go_to_altitude(desiredAltitude):
  ...
  altitudeSub = rospy.Subscriber("/bebop/states/ardrone3/PilotingState/AltitudeChanged", Ardrone3PilotingStateAltitudeChanged, altitude_callback, (desiredAltitude))
