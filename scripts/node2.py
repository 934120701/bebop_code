...
class image_converter:
  ...
  def publish_the_message(self, camera_angle):
    ...
    while not rospy.is_shutdown():
      ...
      self.msg.angular.y = camera_angle
      self.message_pub.publish(msg.angular.y)
  ...
  def callback(self,data):
   ...
   #(rows,cols,channels) = cv_image.shape
    ...
    if (len(corners) != 0):
      ...
      camera_angle = self.camera_angle_correction(aruco_code_center_pixel, -70)
